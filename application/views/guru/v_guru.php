<div class="col-lg-12">
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('guru/insert'),'Tambah', 'class="btn btn-primary"'); ?>
            </div>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="230px">
				<?php 
				echo anchor(site_url('guru/view/'.$guru->kodeguru),'Lihat','class="btn btn-info"'); 
				echo ' | '; 
				echo anchor(site_url('guru/update/'.$guru->kodeguru),'Edit','class="btn btn-success"'); 
				echo ' | '; 
				echo anchor(site_url('guru/delete/'.$guru->kodeguru),'Delete','class="btn btn-danger" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
